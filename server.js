...
const stripe = require('stripe')('sk_test_51RrQMWAicdvqG4FAfkp3Icn8XtZa8BetPApcma2Vl2kR2fRaG4ve94YVBYJZVZWUbXq4zj07eJT716aOfH3lyWjo001adtn8xp');
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            line_items: items.map(item => ({
                price_data: {
                    ...
                    product_data: {
                        name: item.name,
                        images: ['https://your-domain.com/img/heart_monitor.jpg'], // Replace with your actual image URL
                    },
...
app.get('/success', (req, res) => {
    ...
    html = html.replace('id="quantity-display">Quantity: 1', `id="quantity-display">Quantity: ${quantity}`);
    html = html.replace('id="price-display">Price: $249.99', `id="price-display">Price: $${total}`);
